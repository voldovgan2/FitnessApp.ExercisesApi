...
public class ExercisesMessageTopicSubscribersService(IServiceBus serviceBus, Func<CreateUserExerciseCollectionFileAggregatorModel, Task<string>> createItemMethod) :
